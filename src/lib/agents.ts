...
const PALETTE = [
  ...
  { bg: "bg-amber-50",   text: "text-amber-600",   darkBg: "dark:bg-amber-950/30",   darkText: "dark:text-amber-400" },
  { bg: "bg-rose-50",    text: "text-rose-600",    darkBg: "dark:bg-rose-950/30",    darkText: "dark:text-rose-400" },
  { bg: "bg-teal-50",    text: "text-teal-600",    darkBg: "dark:bg-teal-950/30",    darkText: "dark:text-teal-400" },
  { bg: "bg-cyan-50",    text: "text-cyan-600",    darkBg: "dark:bg-cyan-950/30",    darkText: "dark:text-cyan-400" },
  { bg: "bg-indigo-50",  text: "text-indigo-600",  darkBg: "dark:bg-indigo-950/30",  darkText: "dark:text-indigo-400" },
  { bg: "bg-pink-50",    text: "text-pink-600",    darkBg: "dark:bg-pink-950/30",    darkText: "dark:text-pink-400" },
];
